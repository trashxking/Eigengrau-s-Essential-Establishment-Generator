setup.townData = {
  ...
  economicIdeology: {
    ...
    capitalism: {
      ...
      descriptors: {
        ...
        economicIdeologyDescription: 'The people of $town.name work in exchange for payment from their employers, which they use to buy necessities.',
  ...
  misc: {
    ...
    // In town, __ is currently taking place.
    currentEvent: [
      "the anniversary of a monarch's reign",
      'the anniversary of an important event',
      'an arena event',
      'the arrival of a caravan or ship',
      'the arrival of a circus',
      'the arrival of an important npc',
      'the arrival of marching modrons',
      'an artistic performance',
      'an athletic event',
      'the birth of a child',
      'the birthday of an important npc',
      'a civic festival',
      'a comet appearance',
      ...
      'a full moon',
      'a funeral',
      'the graduation of cadets or wizards',
      'a harvest festival',
      'a holy day',
      'the investiture of a knight or other noble',
      'a lunar eclipse',
    ...
    landmark: [
      ...
      'what appears to be a face carved into the side of a cliff, possibly from erosion.',
      'a giant skeleton sticking out of the ground. Looks like a triceratops, but larger.',
      'a giant flower with lots of bees surrounding it. Thousands of flowers similar to the giant one grow around it at a wide range of heights. Different kinds of fey seem to live around it as well.',
      'an overgrown, moss-covered, patinaed statue that looks rather strange.',
      ...
      'a beached shipwreck that has been looted and broken on the shore. It is overgrown with algae, seaweed, and barnacles.',
      'a cliff with sharp rocks below, known to locals as the "maw of the sea."',
      'a large tree that is over 30 feet in diameter. This hulking monstrosity of nature has been cared for by the locals, and some revere it as a god.',
      'a frozen lake with a polished ice surface. If you look closely enough, you can see dead fish floating beneath.',
      ...
      "the ribcage of a giant whale that allegedly fell out of the sky a long time ago, surrounded by a field of petunias. Local legends differ in how it got there, but the most accepted answer is that it was an unexpected side effect of a wizard's reckless attempt to mess with the nature of probability.",
      'a rocky, windy precipice that rises above its surroundings, vultures perched on every available foothold. Locals say the place is terribly cursed, but in reality the vultures only congregate there because the wind allows them to smell corpses from a great distance.',
      'a mountain known as the Stone God’s Thumb, so-named for its fist-like shape and a peak which resembles a thumb. A plot of onions and a natural spring are located at the top.',
      'the Carved Oni Heads, stone markers carved by early Dwarven cultures to ward off demons. The stones break the tree line and denote a path between two prehistoric dwarf cities, each stone just within sight of the other.',
      "the Firefall, a rare geological phenomenon that causes a plume of fire to escape a lone lava tube and cascade down instead of up. There might be something special hidden behind it… but more than likely it's just the charred remains of others who had the same thought.",
      ...
      'a massive mushroom with a wide, flat top. Only the top is visible, the rest being below ground. It will slowly rise from the ground when it thinks no one is watching. If something looks at it while it is extended, it will quickly slam back into the ground.',
      'an old and gnarled tree that has grown over and half-swallowed what appears to be the remains of a cart – the wood has rotted away, but the metal axel is still visible.',
      'a tree that has fallen over a creek, its trunk forming a narrow bridge. It would be easy for a small creature to walk across, but anything larger might have difficulty.',
      'a cluster of bright pink and yellow mushrooms that have grown over and completely blanketed a rotted tree trunk.',
      'a series of miniature arches that are nearly always in the shadow of a larger arch.',
      'an extremely deep and narrow slot canyon. It’s easy to jump over, but one mistep could prove dangerous.',
      'an enormous boulder balanced precariously on a thin, natural pillar.',
      "an area that's densely scattered with enormous bones, perhaps a graveyard where large beasts come to die.",
      ...
      'a small dark cave with an extremely narrow crack in the floor, steam billowing out from it. Due to the nature of the steam and the shape of the cave, it creates a low whistling sound at all times of the day.',
      'a mysterious cluster of destroyed ships, most of them close together and forming into a vague ring shape.',
      'the site of several ruined towers, once connected to a series of watch stations in the surrounding area.',
      'an area of land in a forest where no plants seem to grow.',
      'a dense forest of small trees, with one notably larger tree of the same species towards the center.',
      'a pond of water that rotates one direction in the morning and the other direction in the evening.',
      'a cliff face that appears to have a large portion removed, as if by a giant bite.',
      'a tall rock formation with two boulders around the bottom… Definitely not phallic.',
      'a small statue of a hooded sitting hunched figure that always points slightly northwest.',
      "a large stone monolith towering upon a hillside. Along the back is a single Giant's rune written in charcoal.",
      'a dried up river, with the remains of a long forgotten exodus. Bones stick up through the mud at strange angles.',
      ...
      'a circular depression overgrown with strangely warped vegetation. The very middle is raised and bare rock, which looks almost like cracked dark glass.',
      'a grouping of two trees, an ash and an elm, which have grown so close together that they spiral around one another, their trunks and branches intertwined.',
      ...
      'a sulphuric smoke that constantly rises from an inhospitable series of rock tubes. Large filter feeding red fronds rake the air in an effort to capture nutrients from the plumes of smoke. It glows red and it said to attract lightning strikes.',
      'a lone mountain with a small town at the top. There is something weird about the tortle settlement that leads visitors to think they are hiding something… even the mountain is shaped like a turtle shell.',
      ...
      'a small cave at the start of a river or brook. Inside the cave is a small oasis, including a waterfall, pool of crisp clear water, and flowering vines that crawl up the walls towards an opening in the ceiling.',
      'an old tree with a fox-shaped canopy when viewed from the South East.',
      'a small clearing surrounded by rocks. Inside sit three petrified trolls, each with a horrified look on their face.',
      'what looks like a mountain that has been cut in half. The two extremely close peaks are seperated by a river that flows between them.',
      'a big colorful crystal poking out of the ground. It separates the light that shines through it, throwing miniature rainbows all around.',
      'a tiny volcano that spews small embers, burning the vegetation directly next to it.',
      'a giant’s skeleton on the side of a cliff, a large sword still stuck through its chest.',
      ...
      "a winding path of high ground through a swamp called the Witch's Walk.",
      'a tall rock surrounded by 20 evenly spaced smaller rocks. The smaller rocks have ancient number runes on them.',
      ...
      'a pit that is at least 50 feet deep. The bottom is obscured in shadow.',
      'a group of three treefolk that have pinned down a stone golem. Roots have all but immobilized the once rampaging construct. It’s been 100 years since the battle and the treefolk are still sleepy from all the action.',
      'a group of islands with a mountain range in them. From a distance the peaks resemble a dragon’s claw emerging from the sea.',
      'what appears to be a puddle with a 10 foot radius, but locals claim the pool is actually 30 feet deep. They say that upon diving under, it appears to be full of tropical ocean life, and those submerged can hear what sounds like waves crashing on the surface.',
      'a seemingly floating waterfall that begins nearly 50 feet in the air.',
      'a twenty foot high mushroom, enclosed in a circle of smaller mushrooms of varying heights. The locals say the location had been home to a giant toad who would rest on the largest mushroom, and that occasionally a ghostly ribbit pierces the air.',
      ...
      'a large perpetually raining cloud.',
      'a volcano that is constantly spewing forth smoke, although it has never erupted.',
      ...
      'the Drow Stone – a towering pillar made of a dark, glass-like material. Stories abound of how it marks the entrance to the Underdark, however, it’s simply Volcanic glass from an ancient volcano.',
