...
export function createWeather (town, biome, weather, season, time) {
  ...
  if (weather) {
    ...
    weather = {
      temperature: townData.terrain[biome].weather.season[season].baseTemp || townData.terrain[`temperate`].weather.season[`summer`].baseTemp,
      ...
      precipitationLevel: townData.terrain[biome].weather.season[season].precipitationLevel,
      precipitationIntensity: townData.terrain[biome].weather.season[season].precipitationIntensity
    }
  }
  // console.log('weather:')
  // console.log(weather)
