...
export function merchantMission (town, mission) {
  switch (mission.difficulty) {
    case `easy`:
      mission.readout = randomValue([
    ...
    case `medium`:
      mission.readout = randomValue([
        `a recent venture with a ${randomValue([`supplier`, `rival`, `local official`])} has turned out bad, delaying the processing of materials.`,
