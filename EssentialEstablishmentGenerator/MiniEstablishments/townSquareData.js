...
setup.townSquare = {
  ...
  feature: [
    ...
    `small boxes of ${flora.flowers.stemP.random()} and ${flora.flowers.stemP.random()} lining the streets.`,

    `large boxes of ${flora.flowers.stemP.random()}, ${flora.flowers.stemP.random()}, ${
      flora.flowers.stemP.random()}, and ${flora.flowers.stemP.random()} lining the streets.`,
