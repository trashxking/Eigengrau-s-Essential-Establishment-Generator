    ...
    if (span) {
      switch (type) {
        case `politicalIdeology`:
          span.title = townData.politicalIdeology[town.politicalIdeology].data.description
          break
        case `economicIdeology`:
          span.title = townData.economicIdeology[town.economicIdeology].descriptors.tippy
          break
        case `politicalSource`:
          if (town.politicalSource === `absolute monarchy` || town.politicalSource === `constitutional monarchy`) {
            if (town.politicalIdeology === `autocracy`) {
              span.title = townData.politicalSource[town.politicalSource].autocracy.description
            } else {
              span.title = townData.politicalSource[town.politicalSource][`default`].description
            }
          } else {
            span.title = townData.politicalSource[town.politicalSource].description
          }
      }
      tippy(`#${span.id}`)
    }
