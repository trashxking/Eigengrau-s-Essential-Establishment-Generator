...
setup.adventure = {
  'create' (town) {
    ...
    adventure.ally = createNPC(town, setup.adventure.ally[adventure.allyType])
    adventure.patron = createNPC(town, setup.adventure.patron[adventure.patronType])
